...
def classify_image(image_base64_data,image_path=None):
    imgs = cropped_image_if_2_eye(image_path,image_base64_data)
    result = []
    for img in imgs:
...
def load_saved_artifacts():
    ...
    global __model
    if __model is None:
        with open("./artifact/svaed_model.pkl","rb") as f:
...
def cropped_image_if_2_eye(image_path,base_64_image):
    ...
    if image_path:
        ...
        img=get_cv2_image_from_base64_string(base_64_image)
...
if __name__ == "__main__":
    ...
    # print(classify_image(get_base_64_img_of_virat(),None))
